...
///
/// Igual que en SICODIS, la contraseña maestra está fija en el código
/// (MasterPassword): quien tenga acceso al repositorio puede descifrar el
/// valor de SecureConfig:EncryptedConnection. El cifrado evita que la cadena
/// quede legible a simple vista en appsettings.json; no la protege de quien
...
public static class AesEncryptionHelper
{
    ...
    /// <summary>Contraparte de <see cref="Decrypt(string)"/>, usada por --cifrar.</summary>
    public static string Encrypt(string textoPlano) => Encrypt(textoPlano, MasterPassword);
}
